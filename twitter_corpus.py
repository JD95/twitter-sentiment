...
def gather_tweets():
    ...
    auth = OAuthHandler(
        "Wc9t7Cd5WF6HCM8Mro1rNm20g",
        "xOfovAun6QWFvIP5X02nH3r4fDOiBF9prlEjpMOtlBkqv5uAKP"
    )
    auth.set_access_token(
        "167610478-5l7bxqVwaeEhCrbPzQiVGfXZ1HikEb3kYMyE1OTL",
        "L6DedISLbleJo6svJLThBc1xrhKzFGtEB83ZLmCXPd8oN"
    )
    ...
    stream.filter(locations=[-124.85, 24.39, -66.88, 49.38])
